...
public class Drivetrain extends SubsystemBase {
  /** Creates a new Drivetrain. */
    ...
    private final SwerveModuleV3 Module1 = new SwerveModuleV3(mAzimuth1, mDriveMotor1, new Translation2d(-0.26501, 0.26501), 3, 0.000593, "Module 1"); //002632 0005867
    private final SwerveModuleV3 Module2 = new SwerveModuleV3(mAzimuth2, mDriveMotor2, new Translation2d(0.26501, 0.26501), 4, 0.001790, "Module 2"); //00380 001793
    private final SwerveModuleV3 Module3 = new SwerveModuleV3(mAzimuth3, mDriveMotor3, new Translation2d(0.26501, -0.26501), 5, 0.003690, "Module 3"); //001155 002707
    private final SwerveModuleV3 Module4 = new SwerveModuleV3(mAzimuth4, mDriveMotor4, new Translation2d(-0.26501,  -0.26501), 6, 0.002667, "Module 4"); //00063 002641
